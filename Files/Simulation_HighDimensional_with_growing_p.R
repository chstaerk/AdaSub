...
#save(Save1, file="EBIC1_Toeplitz09_p_increasing_400_2000_simulations500.RData")
#########################################################################
#load("StabCP_stabs_EBIC1_Global07_p_increasing_400_2000_simulations100.RData")
